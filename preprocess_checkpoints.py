...
def reduce_checkpoint(ckpt_path, reduced_path, verbose=True):
    ...
    if os.path.isdir(ckpt_path):
        ...
        for k in list(state_dict.keys()):
            if k.split('.')[1] == 'matching_module' and k.split('.')[4] == 'pre_ln_q':
...
parser.add_argument('--ckpt_name', '-cname', type=str, default='best.ckpt')
# parser.add_argument('--ckpt_name', '-cname', type=str, default=None)
parser.add_argument('--load_dir', '-ld', type=str, default='TRAIN-S')
