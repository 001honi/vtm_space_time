'''
This is only slightly modified from https://github.com/Karel911/TRACER/blob/main/util/metrics.py
Reference: "TRACER: Extreme Attention Guided Salient Object Tracing Network"
'''
